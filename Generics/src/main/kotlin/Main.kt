//here player is an upperbound, only accept types that inherit from the player type
//we have out here to satisfy the covariance,
                                                            // out covariance
class Team<T:Player>(val name:String, val Players:MutableList<in T>):Player(name){
...
open class GamesPlayer( name: String,game:String):Player(name)
...
//    you must place out keyword before the generic type
    ...
    //notice we dont have a generic type say T,  here
...
//    you must place in keyword before the generic type
